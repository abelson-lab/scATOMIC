...
Note that packages DLM and RMagic were removed from CRAN in October 2022 so we installed the archived package.
...
scATOMIC's model assumes the presence at least some cancer cells in a biopsy and should not be used in normal tissue applications. 
