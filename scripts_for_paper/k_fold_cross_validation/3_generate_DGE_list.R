...
library(Matrix)
library(future)
#pass the unbalanced training matrix files from scripts 1 and 2 as arg
...
print(file_name)
path_to_matrix <- paste0("unbalanced_set/", file_name)
path_to_metadata <- paste0("unbalanced_set/", metadata_name)
...
#save markers list
saveRDS(per_dataset_marker_list, paste0("markers_kfold_unbalanced/markers_", strsplit(file_name, "unbalanced_training_count_mat_")[[1]][2]))
