...
#' @param imputation whether to use imputation, we recommend turning this off for fine grained cell subtypes
...
#' }
#'
classify_new_scATOMIC_layer <- function(rf_model, selected_features, rna_counts, cell_names, layer_name, mc.cores, imputation = F, confidence_cutoff = T){
